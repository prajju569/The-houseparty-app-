...
const T = {
  ...
  goldDim: 'rgba(201,168,76,0.18)', green: '#00D37F',
...
export function SwipePartyCards({ events, navigation }: { events: any[]; navigation: any }) {
  ...
  // auto-advance every 5 s, pauses when user scrolls
  function startAuto() {
    stopAuto();
...
const s = StyleSheet.create({
  ...
  hostAvatar: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#2A2A2A' },
  ...
  agePill: {
    backgroundColor: '#1E1E1E', borderRadius: 7,
    paddingHorizontal: 8, paddingVertical: 3,
